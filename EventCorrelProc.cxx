...
for(int gate=0;gate<8;gate++){
     cInput->pFRS_x2AoQ_pass[gate]=true;}
   ...
   FatimaTAMEX_TimeMachine_dT[i]=0;
    ...
    for(int aa=0; aa<cInputMain->pFat_TMCh1mult; aa++){
     ...
     for(int b=0; b<cInputMain->pFat_LeadHits; b++){
       ...
       //cout << (cInputMain->pFat_Fast_LeadT[FatTAMEX_TimeMachineCh2][b]-cInputMain->pFat_Fast_LeadT[FatTAMEX_TimeMachineCh1][b])*5 << endl;
...
//cout<<"cInputMain->pbPlas_FastLeadT[bPLASTIC_ADDITIONAL_CH_MOD][bPlastTimeMachineCh1][c] " <<cInputMain->pbPlas_FastLeadT[bPLASTIC_ADDITIONAL_CH_MOD][bPlastTimeMachineCh1][c] << endl;
 ...
 void EventCorrelProc::Make_FRS_AIDA_Histos() {
  ...
  {    
        ...
        hA_FRS_ZAoQ_implants_strip_xy[gate][i] = MakeTH2('I', Form("Correlations/AIDA-FRS/Implants/All/Z1vsAoQ/Z1vsAoQ_Gate%d/DSSD_XY/DSSD%d_implants_strip_XY_Z1vsAoQ_Gate%d", gate,i+1,gate), Form("DSSD %d implant hit pattern FRS Z1vsAoQ Gate%d", i+1,gate), xstrips, 0, xstrips, 128, 0, 128, "X strip", "Y strip");
        
        hA_FRS_ZAoQ_implants_position[gate][i] = MakeTH2('D', Form("Correlations/AIDA-FRS/Implants/All/Z1vsAoQ/Z1vsAoQ_Gate%d/DSSD_Position/DSSD%d_implant_Position_Z1vsAoQ_Gate%d", gate, i+1,gate), Form("DSSD %d implant position Z vs AoQ Gate %d", i+1,gate), xstrips, -xmax, xmax, 128, -37.8, 37.8, "X position/mm", "Y position/mm");
        
        hA_FRS_ZAoQ_implants_e[gate][i] = MakeTH1('F', Form("Correlations/AIDA-FRS/Implants/All/Z1vsAoQ/Z1vsAoQ_Gate%d/Energy/DSSD%d_implants_energy_Z1vsAoQ_Gate%d", gate,i+1,gate), Form("DSSD %d implant energy FRS AoQ vs Z Gate%d", i+1,gate), 2000, 0, 20000, "Implant Energy/MeV");
        
        hA_FRS_ZAoQ_implants_strip_xy_stopped[gate][i] = MakeTH2('I', Form("Correlations/AIDA-FRS/Implants/Stopped/Z1vsAoQ/Z1vsAoQ_Gate%d/DSSD_XY/DSSD%d_implants_stopped_strip_XY_Z1vsAoQ_Gate%d",gate, i+1,gate), Form("DSSD %d stopped implant hit pattern FRS Z1vsAoQ Gate%d", i+1,gate), xstrips, 0, xstrips, 128, 0, 128, "X strip", "Y strip");
        
        hA_FRS_ZAoQ_implants_position_stopped[gate][i] = MakeTH2('D', Form("Correlations/AIDA-FRS/Implants/Stopped/Z1vsAoQ/Z1vsAoQ_Gate%d/DSSD_Position/DSSD%d_implant_stopped_Position_Z1vsAoQ_Gate%d", gate, i+1,gate), Form("DSSD %d implant stopped position Z vs AoQ Gate%d ", i+1,gate), xstrips, -xmax, xmax, 128, -37.8, 37.8, "X position/mm", "Y position/mm");
           
        hA_FRS_ZAoQ_implants_e_stopped[gate][i] = MakeTH1('F', Form("Correlations/AIDA-FRS/Implants/Stopped/Z1vsAoQ/Z1vsAoQ_Gate%d/Energy/DSSD%d_implants_stopped_energy_Z1vsAoQ_Gate%d", gate,i+1,gate), Form("DSSD %d stopped implant energy FRS AoQ vs Z Gate%d", i+1,gate), 2000, 0, 20000, "Implant Energy/MeV");
        
        
        hA_FRS_Z1Z2_implants_strip_xy[gate][i] = MakeTH2('I', Form("Correlations/AIDA-FRS/Implants/All/Z1vsZ2/Z1vsZ2_Gate%d/DSSD_XY/DSSD%d_implants_strip_XY_Z1Z2g%d", gate,i+1,gate), Form("DSSD %d implant hit pattern, FRS Z1 Z2 Gate %d", i+1,gate), xstrips, 0, xstrips, 128, 0, 128, "X strip", "Y strip");
        
        hA_FRS_Z1Z2_implants_position[gate][i] = MakeTH2('D', Form("Correlations/AIDA-FRS/Implants/All/Z1vsZ2/Z1vsZ2_Gate%d/DSSD_Position/DSSD%d_implant_Position_Z1vsZ2_Gate%d", gate, i+1,gate), Form("DSSD %d implant position FRS Z1 Z2 gate %d", i+1,gate), xstrips, -xmax, xmax, 128, -37.8, 37.8, "X position/mm", "Y position/mm");
        
        hA_FRS_Z1Z2_implants_strip_xy_stopped[gate][i] = MakeTH2('I', Form("Correlations/AIDA-FRS/Implants/Stopped/Z1vsZ2/Z1vsZ2_Gate%d/DSSD_XY/DSSD%d_implants_stopped_strip_XY_Z1Z2g%d", gate,i+1,gate), Form("DSSD %d implant hit pattern, FRS Z1 Z2 Gate %d", i+1,gate), xstrips, 0, xstrips, 128, 0, 128, "X strip", "Y strip");
        
        hA_FRS_Z1Z2_implants_position_stopped[gate][i] = MakeTH2('D', Form("Correlations/AIDA-FRS/Implants/Stopped/Z1vsZ2/Z1vsZ2_Gate%d/DSSD_Position/DSSD%d_implants_stopped_Position_Z1vsZ2_Gate%d", gate, i+1,gate), Form("DSSD %d implant stopped position Z1 Z2 Gate%d", i+1,gate), xstrips, -xmax, xmax, 128, -37.8, 37.8, "X position/mm", "Y position/mm");
        
    
        ///Z1Z2 X2AoQ
        hA_FRS_Z1Z2_x2AoQ_implants_strip_xy[gate][i] = MakeTH2('I', Form("Correlations/AIDA-FRS/Implants/All/Z1Z2_x2AoQ/Z1Z2_x2AoQ_Gate%d/DSSD_XY/DSSD%d_implants_strip_Z1Z2_x2AoQ_Gate%d",gate, i+1,gate), Form("DSSD %d implant hit pattern FRS Z1Z2_x2AoQ_Gate Gate%d", i+1,gate), xstrips, 0, xstrips, 128, 0, 128, "X strip", "Y strip");
           
        hA_FRS_Z1Z2_x2AoQ_implants_e[gate][i] = MakeTH1('F', Form("Correlations/AIDA-FRS/Implants/All/Z1Z2_x2AoQ/Z1Z2_x2AoQ_Gate%d/Energy/DSSD%d_implants_energy_Z1Z2_x2AoQ_Gate%d",gate, i+1,gate), Form("DSSD %d implant energy FRS Z1Z2_x2AoQ_Gate%d", i+1,gate), 2000, 0, 20000, "Implant Energy/MeV");
        
        hA_FRS_Z1Z2_x2AoQ_implants_position[gate][i] = MakeTH2('D', Form("Correlations/AIDA-FRS/Implants/All/Z1Z2_x2AoQ/DSSD_Position/Z1Z2_x2AoQ_Gate%d/DSSD_Position/DSSD%d_implants_Position_Z1Z2_x2AoQ_Gate%d", gate, i+1,gate), Form("DSSD %d implant position Z1Z2_x2AoQ Gate%d", i+1,gate), xstrips, -xmax, xmax, 128, -37.8, 37.8, "X position/mm", "Y position/mm");
        
        hA_FRS_Z1Z2_x2AoQ_implants_position_stopped[gate][i] = MakeTH2('D', Form("Correlations/AIDA-FRS/Implants/Stopped/Z1Z2_x2AoQ/Z1Z2_x2AoQ_Gate%d/DSSD_Position/DSSD%d_implants_stopped_Position_Z1Z2_x2AoQ_Gate%d", gate, i+1,gate), Form("DSSD %d implant stopped position Z1Z2_x2AoQ Gate%d", i+1,gate), xstrips, -xmax, xmax, 128, -37.8, 37.8, "X position/mm", "Y position/mm");
        
        hA_FRS_Z1Z2_x2AoQ_implants_strip_xy_stopped[gate][i] = MakeTH2('I', Form("Correlations/AIDA-FRS/Implants/Stopped/Z1Z2_x2AoQ/Z1Z2_x2AoQ_Gate%d/DSSD_XY/DSSD%d_implants_stopped_strip_Z1Z2_x2AoQ_Gate%d",gate, i+1,gate), Form("DSSD %d implant hit pattern FRS Z1Z2_x2AoQ_Gate Gate%d", i+1,gate), xstrips, 0, xstrips, 128, 0, 128, "X strip", "Y strip");
           
        hA_FRS_Z1Z2_x2AoQ_implants_e_stopped[gate][i] = MakeTH1('F', Form("Correlations/AIDA-FRS/Implants/Stopped/Z1Z2_x2AoQ/Energy/Z1Z2_x2AoQ_Gate%d/Energy/DSSD%d_implants_stopped_energy_Z1Z2_x2AoQ_Gate%d",gate, i+1,gate), Form("DSSD %d stopped implant energy FRS Z1Z2_x2AoQ_Gate%d", i+1,gate), 2000, 0, 20000, "Implant Energy/MeV");
        
        ///Z1Z2 X4AoQ
        hA_FRS_Z1Z2_x4AoQ_implants_strip_xy[gate][i] = MakeTH2('I', Form("Correlations/AIDA-FRS/Implants/All/Z1Z2_x4AoQ/Z1Z2_x4AoQ_Gate%d/DSSD_XY/DSSD%d_implants_strip_Z1Z2_x4AoQ_Gate%d",gate, i+1,gate), Form("DSSD %d implant hit pattern FRS Z1Z2_x4AoQ_Gate Gate%d", i+1,gate), xstrips, 0, xstrips, 128, 0, 128, "X strip", "Y strip");
           
        hA_FRS_Z1Z2_x4AoQ_implants_e[gate][i] = MakeTH1('F', Form("Correlations/AIDA-FRS/Implants/All/Z1Z2_x4AoQ/Z1Z2_x4AoQ_Gate%d/Energy/DSSD%d_implants_energy_Z1Z2_x4AoQ_Gate%d",gate, i+1,gate), Form("DSSD %d implant energy FRS Z1Z2_x4AoQ_Gate%d", i+1,gate), 2000, 0, 20000, "Implant Energy/MeV");
        
        hA_FRS_Z1Z2_x4AoQ_implants_position[gate][i] = MakeTH2('D', Form("Correlations/AIDA-FRS/Implants/All/Z1Z2_x4AoQ/Z1Z2_x4AoQ_Gate%d/DSSD_Position/DSSD%d_implants_Position_Z1Z2_x4AoQ_Gate%d", gate, i+1,gate), Form("DSSD %d implant position Z1Z2_x4AoQ Gate%d", i+1,gate), xstrips, -xmax, xmax, 128, -37.8, 37.8, "X position/mm", "Y position/mm");
        
        hA_FRS_Z1Z2_x4AoQ_implants_position_stopped[gate][i] = MakeTH2('D', Form("Correlations/AIDA-FRS/Implants/Stopped/Z1Z2_x4AoQ/Z1Z2_x4AoQ_Gate%d/DSSD_Position/DSSD%d_implants_stopped_Position_Z1Z2_x4AoQ_Gate%d", gate, i+1,gate), Form("DSSD %d implant stopped position Z1Z2_x4AoQ Gate%d", i+1,gate), xstrips, -xmax, xmax, 128, -37.8, 37.8, "X position/mm", "Y position/mm");
        
        hA_FRS_Z1Z2_x4AoQ_implants_strip_xy_stopped[gate][i] = MakeTH2('I', Form("Correlations/AIDA-FRS/Implants/Stopped/Z1Z2_x4AoQ/Z1Z2_x4AoQ_Gate%d/DSSD_XY/DSSD%d_implants_stopped_strip_Z1Z2_x4AoQ_Gate%d",gate, i+1,gate), Form("DSSD %d implant hit pattern FRS Z1Z2_x4AoQ_Gate Gate%d", i+1,gate), xstrips, 0, xstrips, 128, 0, 128, "X strip", "Y strip");
           
        hA_FRS_Z1Z2_x4AoQ_implants_e_stopped[gate][i] = MakeTH1('F', Form("Correlations/AIDA-FRS/Implants/Stopped/Z1Z2_x4AoQ/Z1Z2_x4AoQ_Gate%d/Energy/DSSD%d_implants_stopped_energy_Z1Z2_x4AoQ_Gate%d",gate, i+1,gate), Form("DSSD %d stopped implant energy FRS Z1Z2_x4AoQ_Gate%d", i+1,gate), 2000, 0, 20000, "Implant Energy/MeV");
...
/**----------------------------------------------------------------------------------------------**/
   ...
   int ch_sideD=-1;
			...
			ch_sideB=b-8;
                ...
                for (int c = 0; c < bPLASTIC_TAMEX_HITS; c++){ 
                    if(bPlast_SideB==true){
                       ...
                       // if( a==bPLASTIC_UPSTREAM_DET && cInputMain->pbPlas_Slow_ToTCalib[a][b][c]>0)   {  hbPlastUpstreamSideB_ToTvsChan->Fill(ch_sideB,cInputMain->pbPlas_Slow_ToTCalib[a][b][c]);
                       ...
                       // if( a==bPLASTIC_DOWNSTREAM_DET && cInputMain->pbPlas_Slow_ToTCalib[a][b][c]>0)   {  hbPlastDownstreamSideB_ToTvsChan->Fill(ch_sideB,cInputMain->pbPlas_Slow_ToTCalib[a][b][c]);
                 ...
                 if(a==bPLASTIC_UPSTREAM_DET && cInputMain->pbPlas_Slow_ToTCalib[a][b][c]>0){
                    for(int gate=0; gate<MAX_FRS_GATE;gate++){
                       ...
                       // cout<<"UP ch_sideD " <<ch_sideD << " cInputMain->pbPlas_Slow_ToTCalib[a][b][c] " <<cInputMain->pbPlas_Slow_ToTCalib[a][b][c] << " gate " << gate << endl;
                             }
                    }
                 }
                        ...
                        //cout<<"DOWN ch_sideD " <<ch_sideD << " cInputMain->pbPlas_Slow_ToTCalib[a][b][c] " <<cInputMain->pbPlas_Slow_ToTCalib[a][b][c] << " gate " << gate << endl;
                                }
                                   }
                              }
      ...
      for (auto& cInputRef : cInputMain->pAida)
     {
       ...
       ///AIDA Implants
         ...
         ///bPlast stopped for s496
     //  for(int a=1; a<3; a++){ ///Detector number
	 if(cInput->Implants.size()==0&& cInputMain->pFRS_WR>0){
            for (int b = 0; b <bPLASTIC_CHAN_PER_DET; b++){
                 for (int c = 0; c < bPLASTIC_TAMEX_HITS; c++){ 
		  if(cInputMain->pbPlas_Slow_ToTCalib[bPLASTIC_UPSTREAM_DET][b][c]>0 ){
        // hbPlast_Upstream_Stopped[b]->Fill(cInputMain->pbPlas_Slow_ToTCalib[1][b][c]);
		  hbPlast_Upstream_ToTvsChan_Stopped->Fill(b,cInputMain->pbPlas_Slow_ToTCalib[bPLASTIC_UPSTREAM_DET][b][c]);
         
		    for(int gate=0; gate<MAX_FRS_GATE;gate++){
		      if(cInputMain->pFRS_ZAoQ_pass[gate]==true ){
          //hbPlast_Upstream_Stopped_PIDGated[gate][b]->Fill(cInputMain->pbPlas_Slow_ToTCalib[1][b][c]);
			  hbPlast_Upstream_ToTvsChan_Stopped_PIDGated[gate]->Fill(b,cInputMain->pbPlas_Slow_ToTCalib[bPLASTIC_UPSTREAM_DET][b][c]);
                            }
                        }
                 }
            }
    ...
    ///Gate on FRS Z vs AoQ -> AIDA Implantation
	  ...
	  if(hit.DSSD - 1==2 && cInputMain->pbPlas_FastLeadT[3][6][0]!=0)
	 hA_FRS_ZAoQ_implants_strip_xy_stopped[gate][hit.DSSD - 1]->Fill(hit.StripX, hit.StripY);
         hA_FRS_ZAoQ_implants_e_stopped[gate][hit.DSSD - 1]->Fill(hit.Energy);
         hA_FRS_ZAoQ_implants_position_stopped[gate][hit.DSSD - 1]->Fill(hit.PosX, hit.PosY);
               }
 ...
 void EventCorrelProc::Make_FRS_Prompt_Ge_Histos(){
      ...
      hA_FRS_ZAoQ_GeEvsT_all= MakeTH2('D',"Correlations/FRS-Prompt_Ge/Z1vsAoQ_Ge/GeE_vs_FRSGe_dT_Z1vsAoQ_All","Ge vs T all", 2000,-10000,10000,fCorrel->GGe1_Ge2_HistoBin,fCorrel->GGe1_Ge2_HistoMin,fCorrel->GGe1_Ge2_HistoMax, "FRS - Ge time (ns)", "Ge Energy (keV)");
      hA_FRS_ZAoQ_GeEvsT_WR_all= MakeTH2('D',"Correlations/FRS-Prompt_Ge/Z1vsAoQ_Ge/GeE_vs_FRSGe_dT_Z1vsAoQ_WR_All","Ge vs T all", 2000,-10000,10000,fCorrel->GGe1_Ge2_HistoBin,fCorrel->GGe1_Ge2_HistoMin,fCorrel->GGe1_Ge2_HistoMax, "FRS - Ge time (ns)", "Ge Energy (keV)");
      hA_FRS_ZAoQ_GeEvsT_WR_gate1_all= MakeTH2('D',"Correlations/FRS-Prompt_Ge/Z1vsAoQ_Ge/GeE_vs_FRSGe_dT_Z1vsAoQ_WR_gate1_All","Ge vs T all with WR gate", 2000,-10000,10000,fCorrel->GGe1_Ge2_HistoBin,fCorrel->GGe1_Ge2_HistoMin,fCorrel->GGe1_Ge2_HistoMax, "FRS - Ge time (ns)", "Ge Energy (keV)");
      
       hA_FRS_Ge_WR_timediff  = MakeTH1('I', "Correlations/FRS-Prompt_Ge/FRS_Ge_WR_time_difference", "WR FRS Ge time difference", 10000,-10000,10000, "time [ns]");

     // for(int i=0; i<(Germanium_MAX_DETS-1); i++){
      for(int i=0; i<4; i++){
      // for(int j=0; j<Germanium_CRYSTALS; j++){
       for(int j=0; j<7; j++){
       hA_FRS_ZAoQ_GeEvsT_ind[i][j] = MakeTH2('D',Form("Correlations/FRS-Prompt_Ge/Z1vsAoQ_Ge/GeE_vs_FRSGe_dT_Det_%2d_Crys_%2d",i,j),Form("T Diff FRS WR - Germanium T vs Germanium Energy Det %2d Crys %2d",i,j), 2000,-10000,10000,fCorrel->GGe1_Ge2_HistoBin,fCorrel->GGe1_Ge2_HistoMin,fCorrel->GGe1_Ge2_HistoMax,"FRS - Ge time (ns)", "Ge Energy (keV)");
       }
      }
      ...
      for(int i=0; i<MAX_FRS_GATE; i++){
       ...
       hA_FRS_ZAoQ_GeEvsT[i]  = MakeTH2('D',Form("Correlations/FRS-Prompt_Ge/Z1vsAoQ_Ge/GeE_vs_FRSGe_dT/GeE_vs_FRSGe_dT_Z1vsAoQ_Gate%d",i),Form("T Diff FRS WR - Germanium T vs Germanium Energy Gate %d",i), 2000,-10000,10000,fCorrel->GGe1_Ge2_HistoBin,fCorrel->GGe1_Ge2_HistoMin,fCorrel->GGe1_Ge2_HistoMax,"FRS - Ge time (ns)", "Ge Energy (keV)");
...
//      }
 ...
 void EventCorrelProc::Process_FRS_Prompt_Ge(EventAnlStore* cInputMain, EventCorrelStore* cOutput){
     ...
     for(int x=0; x< Germanium_MAX_HITS; x++){
      ...
      dT_frsge_prompt=-1000;
      Ge_mult_prompt=0;
      dT_frsge_mult_prompt=0;
      dT_GeT_prompt=0;
      Ge_FirstT_prompt=0;
      tmp_timediff=-1000;
      int WR_gated_FRS_Ge=0;// 0 >> no WR gated, 1>> with WR gated
      int WR_gated_1_FRS_Ge=0;// 0 >> no WR gated, 1>> with WR gated
    

   if(cInputMain->pFRS_WR>0 && cInputMain->pGe_WR>0){
         dT_frsge_prompt = (cInputMain->pGe_WR - cInputMain->pFRS_WR);
          hA_FRS_Ge_WR_timediff->Fill(dT_frsge_prompt);
        if(dT_frsge_prompt>fCorrel->GFRS_Ge_TLow && dT_frsge_prompt < fCorrel->GFRS_Ge_THigh){WR_gated_FRS_Ge=1;}
        if(dT_frsge_prompt>50 && dT_frsge_prompt < 150){WR_gated_1_FRS_Ge=1;}
   }
 ///WR Time gate FRS-Ge GLOBAL dT GATE

    if(cInputMain->pGe_T[Germanium_SC41_Det][Germanium_SC41L_Crystal_Digi]>0){
     for(int g=0; g<(Germanium_MAX_DETS-1); g++){
            for(int h=0; h<Germanium_CRYSTALS; h++){
          if(cInputMain->pGe_TAddback[g][h]>0&&cInputMain->pGe_EAddback[g][h]>30){
          tmp_timediff= cInputMain->pGe_TAddback[g][h]-cInputMain->pGe_T[Germanium_SC41_Det][Germanium_SC41L_Crystal];
      //    if(tmp_timediff<=0)cin.get();
    // hA_FRS_ZAoQ_GeEvsT_all->Fill((cInputMain->pGe_TAddback[g][h] - cInputMain->pGe_T[Germanium_SC41_Det][Germanium_SC41L_Crystal_Digi]),cInputMain->pGe_EAddback[g][h]);
     hA_FRS_ZAoQ_GeEvsT_all->Fill(tmp_timediff,cInputMain->pGe_EAddback[g][h]);
     hA_FRS_ZAoQ_GeEvsT_ind[g][h]->Fill(tmp_timediff,cInputMain->pGe_EAddback[g][h]);
     if(WR_gated_FRS_Ge==1) hA_FRS_ZAoQ_GeEvsT_WR_all->Fill(tmp_timediff,cInputMain->pGe_EAddback[g][h]);
     if(WR_gated_1_FRS_Ge==1) hA_FRS_ZAoQ_GeEvsT_WR_gate1_all->Fill(tmp_timediff,cInputMain->pGe_EAddback[g][h]);
      tmp_timediff=-1000;
 ...
 //      if(cGe_EdT_cut[gate]->Test(tmp_timediff,cInputMain->pGe_EAddback[g][h])==true) {
              ///Z vs A/Q gated 
             if(cInputMain->pFRS_ZAoQ_pass[gate]==true && tmp_timediff!=-1000 && WR_gated_FRS_Ge==1){
                hA_FRS_ZAoQ_GeE[gate]->Fill(cInputMain->pGe_EAddback[g][h]);
                hA_FRS_ZAoQ_GeEvsT[gate]->Fill(tmp_timediff,cInputMain->pGe_EAddback[g][h]);
                tmp_timediff=-1000;
                                }
  //                           }
                       }///End of gate loop
...
/**----------------------------------------------------------------------------------------------**/
 ...
 void EventCorrelProc::Make_FRS_Prompt_Fat_Histos(){
     ...
     //zgx
      hA_FRS_ZAoQ_Fat_SC41L_SC41R[i] = MakeTH2('D',Form("Correlations/FRS-Prompt_Fatima/Z1vsAoQ/FatE_vs_FRSFat_dT/SC41L_SC41R_ZAoQGate%2d",i), Form("SC41L vs SC41R Gate%2d",i),4e3,-10000,90000,4e3,-10000,90000,"L ns","R ns"); 
     //zgx
     //
          ///ZAoQ
 ...
 void EventCorrelProc::Process_FRS_Prompt_Fat(EventAnlStore* cInputMain, EventCorrelStore* cOutput){
     ...
     //   if(dT_FRS_Fatima!=0) hA_FRSWR_FatWR->Fill(dT_FRS_Fatima);
          ...
          ///Energy WR dT
                ...
                if(dT_FRS_Fatima>fCorrel->GFRS_Fat_TLow && dT_FRS_Fatima < fCorrel->GFRS_Fat_THigh){
                    ...
                    if(cInputMain->pFat_QDC_E[k]>0){
                     ...
                     for(int gate=0;gate<MAX_FRS_GATE;gate++){
              //zgx          
              if(cInputMain->pSC41L[0]>0 && cInputMain->pFat_TDC_T[k]>0){
        
                    ///This is the Prompt flash cut (accepted)
      if(cFat_EdT_cut[gate]->Test((cInputMain->pFat_TDC_T[k]-cInputMain->pSC41L[0])*0.025,cInputMain->pFat_QDC_E[k])==true){
             
                         ///Z vs A/Q spectra
                   
            if(cInputMain->pFRS_ZAoQ_pass[gate]==true ){

                     for(int ii=0;ii<cInputMain->pSC41L_mult;ii++) {
                   if(cInputMain->pSC41L[ii]>0&&cInputMain->pSC41R[ii]>0) hA_FRS_ZAoQ_Fat_SC41L_SC41R[gate]->Fill(cInputMain->pSC41L[ii]*0.025, cInputMain->pSC41R[ii]*0.025);
                       }
                hA_FRS_ZAoQ_FatE[gate]->Fill(cInputMain->pFat_QDC_E[k]);
                    
                    if(cInputMain->pFat_TDC_T[k]>0){
                    hA_FRS_ZAoQ_FatEvsT[gate]->Fill((cInputMain->pFat_TDC_T[k]-cInputMain->pSC41L[0])*0.025, cInputMain->pFat_QDC_E[k]);
                            }
                ...
                for(int l=0; l<cInputMain->pFatmult; l++){
                   // if(k!=l && (cInputMain->pFat_TDC_T[k]-cInputMain->pFat_TDC_T[l])*0.025>fCorrel->GFat1_Fat2_Low && (cInputMain->pFat_TDC_T[k]-cInputMain->pFat_TDC_T[l])*0.025<fCorrel->GFat1_Fat2_High){
                    if(k!=l && (cInputMain->pFat_TDC_T[k]-cInputMain->pFat_TDC_T[l])*0.025>fCorrel->GFat1_Fat2_Low && (cInputMain->pFat_TDC_T[k]-cInputMain->pFat_TDC_T[l])*0.025<fCorrel->GFat1_Fat2_High&&(cInputMain->pFat_TDC_T[k]-cInputMain->pSC41L[0])*0.025>0 && (cInputMain->pFat_TDC_T[l]-cInputMain->pSC41L[0])*0.025>0) {
                   ...
                   if(cInputMain->pFRS_Z_Z2_pass[gate]==true){
                    ...
                    //  if(cInputMain->pFRS_x2AoQ_pass[gate]==true ){
                      ...
                      if(cInputMain->pFat_TDC_T[k]>0) hA_FRS_Z1Z2_X2AoQ_FatEvsT[gate]->Fill((cInputMain->pFat_TDC_T[k]-cInputMain->pSC41L[0])*0.025, cInputMain->pFat_QDC_E[k]);
                 ...
                 ///Z1 Z2:  X4 A/Q gate
                       if(cInputMain->pFRS_x4AoQ_pass[gate]==true){  
                        ...
                        if(cInputMain->pFat_TDC_T[k]>0) hA_FRS_Z1Z2_X4AoQ_FatEvsT[gate]->Fill((cInputMain->pFat_TDC_T[k]-cInputMain->pSC41L[0])*0.025, cInputMain->pFat_QDC_E[k]);
              ...
              for(int k=0; k<cInputMain->pFatmult; k++){
               ...
               if(cFat_EdT_cut[fCorrel->GPID_Gate_FRS_Fatima_LT]->Test((cInputMain->pFat_TDC_T[k]-cInputMain->pSC41L[0])*0.025,cInputMain->pFat_QDC_E[k])==true){
      ...
      /// --------------------Start-Stop -------------------------------------///           
        ...
        for(int l=0; l<cInputMain->pFatmult; l++){
            if(k!=l && cFat_EdT_cut[fCorrel->GPID_Gate_FRS_Fatima_LT]->Test((cInputMain->pFat_TDC_T[l]-cInputMain->pSC41L[0])*0.025,cInputMain->pFat_QDC_E[l])==true){
...
//                   if(cGe_EdT_cut[gate]->Test(cInputMain->pGal_EAddback[g][h],dT_frsge_prompt)==false) 
    ...
    if(cInputMain->pFRS_WR>0 && cInputMain->pFAT_WR>0)  dT_FRS_Fatima_WR = cInputMain->pFAT_WR - cInputMain->pFRS_WR;
        ...
        if(cInputMain->pFRS_ZAoQ_pass[fCorrel->GLongIso_PID_Gate]==true){
                ...
                for(int k=0; k<cInputMain->pFatmult; k++){
              dT_frsfat_prompt = ((cInputMain->pFat_TDC_T[k]-cInputMain->pSC41L[0])*0.025);
...
//        }
        if( cFat_EdT_cut[fCorrel->GLongIso_PID_Gate]->Test((cInputMain->pFat_TDC_T[k]-cInputMain->pSC41L[0])*0.025,cInputMain->pFat_QDC_E[k])==true){
 ...
 /**-----------------------------------------------------------------**/
  ...
  void EventCorrelProc::Make_Beta_Gamma_bPlast_SpillOff_Histos(){
     ...
     for(int j=0; j<bPLASTIC_CHAN_PER_DET; j++){  
      hbPlas_ToT_SpillOff[i][j] = MakeTH1('D', Form("Correlations/bPlast_Gamma/bPlastSpillOff/ToT Plas Det SpillOff. %2d Ch. %2d",  i,j), Form("ToT Spill Off Det. %2d Ch. %2d", i,j),40000, 0., 400000.);
      hbPlas_ToT_SpillOn[i][j] = MakeTH1('D', Form("Correlations/bPlast_Gamma/bPlastSpillOn/ToT Plas Det SpillOn. %2d Ch. %2d",  i,j), Form("ToT Spill On Det. %2d Ch. %2d", i,j),40000, 0., 400000.);
                }          
            }
  }
/**-----------------------------------------------------------------**/
...
//                if(GeE_bPlast[m]>0)     hbPlast_SpillOff_Germanium_gcut->Fill(GeE_bPlast[m]);
 ...
 void EventCorrelProc::Make_Beta_Gamma_Histos(){
     ...
     hAidaImpDecdT = MakeTH1('F', "Correlations/Beta_Delayed_Gammas/Germanium/dT(Implant-Decay)_All", " Implant Decay Time", fCorrel->GAidaImpDecT_HBin, fCorrel->GAidaImpDecT_Low, fCorrel->GAidaImpDecT_High, "Energy/keV","Imp-Dec (s)");
      ...
      //HELENA
     hFRS_Z_AoQ_DSSD1_stopped = MakeTH2('D',"Correlations/AIDA-FRS/FRS_Z_AoQ_DSSD1_stopped","FRS_Z_AoQ_DSSD1_stopped",1500,2,3, 1000,20,60, "AoQ", "Z");     
     hFRS_Z_AoQ_DSSD2_stopped = MakeTH2('D',"Correlations/AIDA-FRS/FRS_Z_AoQ_DSSD2_stopped","FRS_Z_AoQ_DSSD2_stopped",1500,2,3, 1000,20,60, "AoQ", "Z");  
    // hFRS_Z_AoQ_DSSD3_stopped = MakeTH2('D',"Correlations/AIDA-FRS/FRS_Z_AoQ_DSSD3_stopped","FRS_Z_AoQ_DSSD3_stopped",1500,2,3, 1000,20,60, "AoQ", "Z");  
    
     hFRS_Z_AoQ_DSSD1_allhits = MakeTH2('D',"Correlations/AIDA-FRS/FRS_Z_AoQ_DSSD1_allhits","FRS_Z_AoQ_DSSD1_allhits",1500,2,3, 1000,20,60, "AoQ", "Z");     
     hFRS_Z_AoQ_DSSD2_allhits = MakeTH2('D',"Correlations/AIDA-FRS/FRS_Z_AoQ_DSSD2_allhits","FRS_Z_AoQ_DSSD2_allhits",1500,2,3, 1000,20,60, "AoQ", "Z");  
    // hFRS_Z_AoQ_DSSD3_allhits = MakeTH2('D',"Correlations/AIDA-FRS/FRS_Z_AoQ_DSSD3_allhits","FRS_Z_AoQ_DSSD3_allhits",1500,2,3, 1000,20,60, "AoQ", "Z");       
     
     //MARTA
     hFRS_Z_AoQ_DSSD1_stopped_dEvsZ = MakeTH2('D',"Correlations/AIDA-FRS/FRS_Z_AoQ_DSSD1_stopped_dEvsZ","FRS_Z_AoQ_DSSD1_stopped_dEvsZ",1500,2,3, 1000,20,60, "AoQ", "Z");     
     hFRS_Z_AoQ_DSSD2_stopped_dEvsZ = MakeTH2('D',"Correlations/AIDA-FRS/FRS_Z_AoQ_DSSD2_stopped_dEvsZ","FRS_Z_AoQ_DSSD2_stopped_dEvsZ",1500,2,3, 1000,20,60, "AoQ", "Z");  
     //hFRS_Z_AoQ_DSSD3_stopped_dEvsZ = MakeTH2('D',"Correlations/AIDA-FRS/FRS_Z_AoQ_DSSD3_stopped_dEvsZ","FRS_Z_AoQ_DSSD3_stopped_dEvsZ",1500,2,3, 1000,20,60, "AoQ", "Z");
...
///---------------------------------------------------------------------------------------------//
 ...
 void EventCorrelProc::Process_Beta_Gamma(EventAnlStore* cInputMain, EventCorrelStore* cOutput){    
     ...
     TAidaConfiguration const* conf = TAidaConfiguration::GetInstance();
        ...
        Int_t strx_Gate[MAX_FRS_GATE];
        Int_t stry_Gate[MAX_FRS_GATE];
...
for(int i=0;i<MAX_FRS_GATE;i++){
 ...
 //}///End of punchthrough 
//  if(i==0) cout<<"lastdT_Gate[0] " << lastdT_Gate[0]<<endl;
  for(int i=0;i<MAX_FRS_GATE;i++){

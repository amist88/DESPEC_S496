...
//  }
 ...
 // id->Z_HTM_select = 1; //1=sc21, 2=sc22, 3=scM01
  ...
  frs->bfield[2] = 6.3686; //                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[3] = 6.3686; //                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 

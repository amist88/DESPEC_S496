...
// id->Z_HTM_select = 1; //1=sc21, 2=sc22, 3=scM01
  ...
  frs->bfield[2] = 6.3827; //                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[3] = 6.3827; //                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
...
// MUSIC42 velocity 12.05.21 Xe s496
  ...
  music->exclude_de1_adc_channel[4] = kFALSE;

...
///Use NIM TAC (0), FRS MHTDC (1) or VFTX (2) for Analysis  
#define MHTDC_TAC_VFTX 0
...
#define FAT_MAX_VME_CHANNELS 55 
#define FAT_TDC_REF_CHANNEL 1
#define FAT_VME_MAX_MULTI 55
...
#define bPLASTIC_FATVME 10
#define SC41L_bPLASTIC 13
#define SC41R_bPLASTIC 12
#define bPLASTIC_OR_UP_DOWN 3
#define bPLASTIC_UP_COIN 8
#define bPLASTIC_DOWN_COIN 8
///bPlast Time Machine Channels
#define bPlastTimeMachineCh1 15
#define bPlastTimeMachineCh2 14
///bPlastic refence channels
#define bPlastRefCh_Det1 8
#define bPlastRefCh_Det2 8
#define bPlastRefCh_Det3 8

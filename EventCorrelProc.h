  ...
  //  void Fat_TimeCorrection(EventAnlStore* cInput);
    ...
    //  std::vector<TH2*> hA_FRS_Z1Z2_implants_strip_xy;
      ...
      //For the long isomer correlations
        ...
        TH2 *hbPlastUpstreamSideB_ToTvsChan;
        TH2 *hbPlastDownstreamSideB_ToTvsChan;
        TH2 *hbPlastUpstreamSideB_ToTvsChan_PIDGated[MAX_FRS_GATE];
        TH2 *hbPlastDownstreamSideB_ToTvsChan_PIDGated[MAX_FRS_GATE];
	
	TH2 *hbPlastUpstreamSideD_ToTvsChan;
        TH2 *hbPlastDownstreamSideD_ToTvsChan;
        TH2 *hbPlastUpstreamSideD_ToTvsChan_PIDGated[MAX_FRS_GATE];
        TH2 *hbPlastDownstreamSideD_ToTvsChan_PIDGated[MAX_FRS_GATE];
	
//         TH1 *hbPlast_Upstream_Stopped[bPLASTIC_CHAN_PER_DET];
//         TH1 *hbPlast_Upstream_Stopped_PIDGated[MAX_FRS_GATE][bPLASTIC_CHAN_PER_DET];
	TH2 *hbPlast_Upstream_ToTvsChan_Stopped;
	TH2 *hbPlast_Upstream_ToTvsChan_Stopped_PIDGated[MAX_FRS_GATE];
...
//       std::vector<std::vector<TH1*>> hA_FRS_ZAoQ_implants_e_gate;
     ...
     // std::vector<TH2*> hA_FRS_Z1Z2_x2AoQ_implants_e_xy;
      ...
      TH2 *hA_FRS_ZAoQ_Fat_SC41L_SC41R[MAX_FRS_GATE];
     ...
     //Ge_FRS 
      TH1 *hA_FRS_Ge_WR_timediff;
      TH1 *hA_FRSWR_GeWR;
      TH1 *hA_FRS_GeE;
      TH2 *hA_FRS_ZAoQ_GeEvsT_ind[4][7];
      TH2 *hA_FRS_ZAoQ_GeEvsT_all;
      TH2 *hA_FRS_ZAoQ_GeEvsT_WR_all;
      TH2 *hA_FRS_ZAoQ_GeEvsT_WR_gate1_all;

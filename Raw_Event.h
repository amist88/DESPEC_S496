...
public:
    ...
    void set_DATA_ID_VFTX(Float_t*, Float_t*,Float_t*,Float_t*,Float_t*,Float_t*,Float_t*,Float_t*,Float_t*,Float_t*,Float_t*,Float_t*,Float_t*,Float_t*);
...
// 						  std::vector<double> &VME_TDC_Data,std::vector<double> &VME_TDC_Channels);
   ...
   // Double_t get_FRS_TRaw_vftx(int i);
    ...
    Float_t get_FRS_vftx_beta_2141(int i); 
    Float_t get_FRS_vftx_gamma_2141(int i);
    Float_t get_FRS_vftx_aoq_2141(int i);
    Float_t get_FRS_vftx_aoq_2141_corr(int i);
    Float_t get_FRS_vftx_2141_z(int i);
    Float_t get_FRS_vftx_2141_z2(int i);
    Float_t get_FRS_vftx_2141_v_cor(int i);
    Float_t get_FRS_vftx_beta_2241(int i);
    Float_t get_FRS_vftx_gamma_2241(int i);
    Float_t get_FRS_vftx_aoq_2241(int i);
    Float_t get_FRS_vftx_aoq_2241_corr(int i);
    Float_t get_FRS_vftx_2241_z(int i);
    Float_t get_FRS_vftx_2241_z2(int i);
    Float_t get_FRS_vftx_2241_v_cor(int i);

...
export ROOT_INCLUDE_PATH=/lustre/gamma/DESPEC_S496_NEARLINE
...
LISTFILE="/lustre/gamma/DESPEC_S496_NEARLINE/Cluster_Submission/file_list.txt"
...
go4analysis -file ${part[*]} -enable-asf 12000 -asf /lustre/gamma/DESPEC_S496_NEARLINE/Cluster_Submission/Nearline_Histograms/S496_run45_$SLURM_ARRAY_TASK_ID.root

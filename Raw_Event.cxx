...
void Raw_Event::set_DATA_VFTX(Double_t* vftx_21l, Double_t* vftx_21r,Double_t* vftx_22l, Double_t* vftx_22r,Double_t* vftx_41l, Double_t* vftx_41r, Double_t* vftx_42l, Double_t* vftx_42r, Float_t* vftx_tof2141,Float_t* vftx_tof2141_calib,Float_t* vftx_tof2241,Float_t* vftx_tof2241_calib){
    ...
    TRaw_vftx_22R[i] = vftx_22r[i];
    TRaw_vftx_41L[i] = vftx_41l[i];
    TRaw_vftx_41R[i] = vftx_41r[i];
    TRaw_vftx_42L[i] = vftx_42l[i];
    TRaw_vftx_42R[i] = vftx_42r[i];
    ToF_vftx_2141[i] = vftx_tof2141[i];
...
void Raw_Event::set_DATA_ID_VFTX(Float_t* vftx_beta_2141, Float_t* vftx_gamma_2141,Float_t* vftx_aoq_2141,Float_t* vftx_aoq_2141_corr,Float_t* vftx_2141_z,Float_t* vftx_2141_z2,Float_t* vftx_2141_v_cor,Float_t* vftx_beta_2241,Float_t* vftx_gamma_2241,Float_t* vftx_aoq_2241,Float_t* vftx_aoq_2241_corr,Float_t* vftx_2241_z,Float_t* vftx_2241_z2,Float_t* vftx_2241_v_cor){
//      for(int i=0; i<32; i++){
...
//      //cout<<"1RAW " << " ID_vftx_aoq_2241[i] " <<ID_vftx_aoq_2241[i] << endl;
//     }
    
    for(int i=0; i<32; i++){
     ID_vftx_beta_2141[i] = vftx_beta_2141[i];
     ID_vftx_gamma_2141[i] =vftx_gamma_2141[i];
     ID_vftx_aoq_2141[i] =vftx_aoq_2141[i];
     ID_vftx_aoq_2141_corr[i] =vftx_aoq_2141_corr[i];
     ID_vftx_2141_z[i] =vftx_2141_z[i];
     ID_vftx_2141_z2[i] =vftx_2141_z2[i];
     ID_vftx_2141_v_cor[i] =vftx_2141_v_cor[i];
     ID_vftx_beta_2241[i] =vftx_beta_2241[i];
     ID_vftx_gamma_2241[i] =vftx_gamma_2241[i];
     ID_vftx_aoq_2241[i] =vftx_aoq_2241[i];
     ID_vftx_aoq_2241_corr[i] =vftx_aoq_2241_corr[i];
     ID_vftx_2241_z[i] =vftx_2241_z[i];
     ID_vftx_2241_z2[i] =vftx_2241_z2[i];
     ID_vftx_2241_v_cor[i] =vftx_2241_v_cor[i];
  //if(ID_vftx_aoq_2241[i]>0)  cout<<"2RAW " << " ID_vftx_aoq_2241[i] " <<ID_vftx_aoq_2241[i] << endl;
    }
}
...
Double_t Raw_Event::get_FRS_TRaw_vftx_21l(int i){return TRaw_vftx_21L[i];}
Double_t Raw_Event::get_FRS_TRaw_vftx_21r(int i){return TRaw_vftx_21R[i];}
Double_t Raw_Event::get_FRS_TRaw_vftx_22l(int i){return TRaw_vftx_22L[i];}
Double_t Raw_Event::get_FRS_TRaw_vftx_22r(int i){return TRaw_vftx_22R[i];}
Double_t Raw_Event::get_FRS_TRaw_vftx_41l(int i){return TRaw_vftx_41L[i];}
Double_t Raw_Event::get_FRS_TRaw_vftx_41r(int i){return TRaw_vftx_41R[i];}
Double_t Raw_Event::get_FRS_TRaw_vftx_42l(int i){return TRaw_vftx_42L[i];}
Double_t Raw_Event::get_FRS_TRaw_vftx_42r(int i){return TRaw_vftx_42R[i];}
Float_t Raw_Event::get_FRS_ToF_vftx_2141(int i){return ToF_vftx_2141[i];}
...
//Double_t Raw_Event::get_FRS_TRaw_vftx(int i){return TRaw_vftx[i];}
    ...
    Float_t Raw_Event::get_FRS_vftx_beta_2141(int i){return ID_vftx_beta_2141[i];} 
    Float_t Raw_Event::get_FRS_vftx_gamma_2141(int i){return ID_vftx_gamma_2141[i];}
    Float_t Raw_Event::get_FRS_vftx_aoq_2141(int i){return ID_vftx_aoq_2141[i];}
    Float_t Raw_Event::get_FRS_vftx_aoq_2141_corr(int i){return ID_vftx_aoq_2141_corr[i];}
    Float_t Raw_Event::get_FRS_vftx_2141_z(int i){return ID_vftx_2141_z[i];}
    Float_t Raw_Event::get_FRS_vftx_2141_z2(int i){return ID_vftx_2141_z2[i];}
    Float_t Raw_Event::get_FRS_vftx_2141_v_cor(int i){return ID_vftx_2141_v_cor[i];}
    Float_t Raw_Event::get_FRS_vftx_beta_2241(int i){return ID_vftx_beta_2241[i];}
    Float_t Raw_Event::get_FRS_vftx_gamma_2241(int i){return ID_vftx_gamma_2241[i];}
    Float_t Raw_Event::get_FRS_vftx_aoq_2241(int i){return ID_vftx_aoq_2241[i];}
    Float_t Raw_Event::get_FRS_vftx_aoq_2241_corr(int i){return ID_vftx_aoq_2241_corr[i];}
    Float_t Raw_Event::get_FRS_vftx_2241_z(int i){return ID_vftx_2241_z[i];}
    Float_t Raw_Event::get_FRS_vftx_2241_z2(int i){return ID_vftx_2241_z2[i];}
    Float_t Raw_Event::get_FRS_vftx_2241_v_cor(int i){return ID_vftx_2241_v_cor[i];}

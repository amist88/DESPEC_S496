...
//       int    FatTDC_Multipl[FAT_VME_MAX_MULTI];
      ...
      Long64_t Fat_WR;
      double SC41L[FAT_VME_MAX_MULTI];
      double SC41R[FAT_VME_MAX_MULTI];
      double SC41L_dig[FAT_VME_MAX_MULTI];
      double SC41R_dig[FAT_VME_MAX_MULTI];
      ...
      double_t Fat_QDC_Singles_t_fine[FAT_VME_MAX_MULTI];
       ...
       // From unpacker
        ...
        //multi of SC41 in Ger 
               int mult_Ge[Germanium_MAX_DETS][Germanium_CRYSTALS];;
               int mult_sc41L_ana;
               int mult_sc41R_ana;
               int mult_sc41L_digi;
               int mult_sc41R_digi;
               ULong64_t Ge_SC41_ana_T[2][Germanium_MAX_HITS];
               ULong64_t Ge_SC41_dig_T[2][Germanium_MAX_HITS];
     ...
     void Do_FRS_Histos(EventUnpackStore* pInput,EventAnlStore* pOutput);
    /// void Do_Plastic_VME_Histos(EventAnlStore* pOutput);
     void Do_Plastic_Twinpeaks_Histos(EventUnpackStore* pInput, EventAnlStore* pOutput);
...
// 	    TH2 *hFIMP_ToT_Correlation_Comb2;
   ...
   //         TH1 *hFAT_SC41;
            TH2 *hFAT_SC41L;
            TH2 *hFAT_SC41R;
            TH2 *hFAT_SC41_LR_all;
  
            TH2 *hFAT_SC41L_digi;
            TH2 *hFAT_SC41R_digi;
            TH2 *hFAT_SC41_LR_all_digi;
            TH2 *hFAT_SC41R_digi_gamma;
            TH2 *hFAT_SC41R_dT_energy_gamma;
            TH2 *hFAT_gamma_energy_time;

            TH1 *hFAT_SC41L_mult;
            TH1 *hFAT_SC41R_mult;
            TH1 *hFAT_SC41L_digi_mult;
            TH1 *hFAT_SC41R_digi_mult;

            ///Germanium Histograms
//	    TH1 *hGe_nocalib[Germanium_MAX_DETS][Germanium_CRYSTALS];
            TH1 *hGe_Chan_E[Germanium_MAX_DETS][Germanium_CRYSTALS];
            TH1 *hGe_Chan_E_Addback[Germanium_MAX_DETS][Germanium_CRYSTALS];
            TH1 *hGe_Chan_E_halfkev[Germanium_MAX_DETS][Germanium_CRYSTALS];
            TH1 *hGe_Chan_Time[Germanium_MAX_DETS][Germanium_CRYSTALS];
            TH1 *hGe_Chan_CF_Time[Germanium_MAX_DETS][Germanium_CRYSTALS];
            ...
            TH2 *hGe_dTvsE[Germanium_MAX_DETS][Germanium_CRYSTALS];

            TH1 *hGe_Chan_mult[Germanium_MAX_DETS][Germanium_CRYSTALS];
            //TH1 *hGe_Chan_E2;
            TH1 *hGe_Chan_Egate;
            TH1 *hGe_AddbackSum;
            ...
            TH1 * hGe_SC41L_Mult;
            TH1 * hGe_SC41R_Mult;
            TH1 * hGe_SC41L_digi_Mult;
            TH1 * hGe_SC41R_digi_Mult;
            TH1 *hGe_SC41_timediff;
            TH1 *hGe_SC41_digi_timediff;


            TH2 *hGe_SC41;
            TH2 *hGe_SC41_digi;
            TH2 *hGe_SC41_time;
            TH2 *hGe_SC41_digi_time;
            ...
            TH1 *hGe_SC41L_time;
            TH1 *hGe_SC41R_time;
            TH1 *hGe_SC41L_digi_time;
            TH1 *hGe_SC41R_digi_time;

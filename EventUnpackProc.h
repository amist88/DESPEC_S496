  ...
  int            scaler_check_first_event = 1;
   ...
   Float_t Music_dE[3], Music_dE_corr[3];
    ...
    Float_t  FRS_vftx_2241_v_cor[32];
            ...
            TH1 *h_VFTX_beta2141;
            TH2 *h_VFTX_x2AoQ2141;
            TH2 *h_VFTX_x2AoQ2241;
            TH1 *h_VFTX_beta2241;
            TH1 *h_VFTX_Z_2141;
            TH1 *h_VFTX_Z2_2141;
            TH1 *h_VFTX_Z_2241;
            TH1 *h_VFTX_Z2_2241;
            TH2 *h_VFTX_Z1Z2_2141;
            TH2 *h_VFTX_Z1Z2_2241;
            TH1 *h_VFTX_AoQ2141;
            TH1 *h_VFTX_AoQ2141corr;
            TH1 *h_VFTX_AoQ2241;
            TH1 *h_VFTX_AoQ2241corr;
            TH2 *h_VFTX_Z1_AoQ2241;
            TH2 *h_VFTX_Z1_AoQ2241corr;
            TH2 *h_VFTX_Z1_AoQ2141corr;
            TH2 *h_VFTX_Z1_AoQ2141;

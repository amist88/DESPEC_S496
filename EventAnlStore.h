...
class EventAnlStore : public TGo4EventElement {
   public:
     ...
     ///AIDA output 
      ...
      Int_t         pSC41L_mult;
      Int_t         pSC41R_mult;
      Int_t         pSC41L_dig_mult;
      Int_t         pSC41R_dig_mult;
      ...
      Long64_t pSC41L[10];
      Long64_t pSC41R[10];
      Long64_t pSC41L_dig[10];
      Long64_t pSC41R_dig[10];
...
//         ULong64_t pGe_TAddback[Germanium_MAX_DETS][Germanium_CRYSTALS];
...
//         ULong64_t pGe_CF_T_Aligned[Germanium_MAX_DETS][Germanium_CRYSTALS];
           Long64_t pGe_Event_T[Germanium_MAX_DETS][Germanium_CRYSTALS];
           Long64_t pGe_T[Germanium_MAX_DETS][Germanium_CRYSTALS];
           Long64_t pGe_TAddback[Germanium_MAX_DETS][Germanium_CRYSTALS];
           Long64_t pGe_T_Aligned[Germanium_MAX_DETS][Germanium_CRYSTALS];
           Long64_t pGe_CF_T[Germanium_MAX_DETS][Germanium_CRYSTALS];
           Long64_t pGe_CF_T_Aligned[Germanium_MAX_DETS][Germanium_CRYSTALS];
